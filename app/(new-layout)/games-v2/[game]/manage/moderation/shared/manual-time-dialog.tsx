...
export function ManualTimeDialog({
    ...
    // Ignore close requests (Escape/backdrop included) while a save is in
    ...
    return (
        <BoardDialog
            ...
            labelledBy="manual-time-title"
            size="lg"
            initialFocusRef={timeFieldRef}
            closeOnBackdropClick={!isSaving}
        >
            <div className="modal-header">
                <h5 className="modal-title" id="manual-time-title">
            ...
            <div className="modal-body">
                <p className="small text-muted mb-3">
                    ...
                    {subcategoryKey ? ` · ${subcategoryKey}` : ''}. This time
                    counts on the board even without a matching run; a faster
