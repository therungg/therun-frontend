...
const EVENT_VERB: Record<string, string> = {
    ...
    'bulk-reject': 'Reject',
    self_reject_run: 'Reject',
    exclude_run: 'Remove',
    bulk_exclude: 'Remove',
    exclude_via_rule: 'Ban',
    ban: 'Ban',
    delete_exclusion_rule: 'Lift ban',
    unban: 'Lift ban',
    lift_ban: 'Lift ban',
    include_run: 'Restore',
    ...
    manual_time_verdict_reject: 'Reject',
    ...
    anonymize_apply: 'Hide identity',
    anonymize_lift: 'Identity restored',
