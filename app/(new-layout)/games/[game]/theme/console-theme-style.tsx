 ...
 * the page's fixed backdrop, as on the board (see `deriveConsoleThemeVars`
 * and console-theme.module.scss). Text colors are the one thing it never takes.
                    ...
                    style={
                        {
                            ...
                            // the image is painted by a pseudo-element (under
                            // the scrim). Keep the
                            ...
                            // carries the color wash, which a board with no
                            // art needs just as much as one with it.
