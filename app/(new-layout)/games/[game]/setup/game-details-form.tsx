            ...
            <FieldLabel
                ...
                hint={
                    <>
                        ...
                        <code>therun.gg/games/sm64</code>. Stored lowercase with
                        non-alphanumerics turned into dashes, and must be unique
                        across all games. Leave it empty to keep the derived
                        name.
                    </>
                }
            />
