...
class CalendarHeatmap extends React.Component {
    constructor(props) {
        ...
        this.history = ["global"];
        this.selected = props.getter
            ? { date: String(props.getter) }
            : props.data[0]
              ? { date: props.data[0].date.slice(0, 4) }
    ...
    createElements() {
        ...
        this.tooltip = d3
            ...
            .style("z-index", 9999)
            .style("width", this.settings.tooltip_width + "px")
            .style("max-width", this.settings.tooltip_width + "px")
    ...
    drawGlobalOverview() {
        ...
        let item_block = this.items
            ...
            .on("click", (event, d) => {
                ...
                // Redraw the chart
                this.overview = "year";
                this.props.setter(this.selected.date.format("Y"));
                this.drawChart();
            })
            .style("opacity", 0)
            .on("mouseover", (event, d) => {
                ...
                let tooltip_html = "";
                tooltip_html +=
                    "<div><span><strong>Total playtime:</strong></span>";
                ...
                if (d.summary.length <= 100) {
                    ...
                    tooltip_html +=
                        "<span>" +
                        this.formatTime(other_projects_sum) +
                        "</span></div>";
                }
        ...
        this.labels
            ...
            .on("mouseenter", (event, year_label) => {
                ...
                this.items
                    ...
                    .ease(d3.easeLinear)
                    .style("opacity", (d) => {
                        return moment(d.date).year() === year_label.year()
                            ? 1
                            : 0.1;
                    });
            })
    ...
    drawYearOverview() {
        ...
        let year_data = this.props.data.filter((d) => {
            return (
                start_of_year <= moment(d.date) && moment(d.date) < end_of_year
            );
        });
        ...
        this.items
            ...
            .attr("x", (d) => {
                return (
                    calcItemX(d) +
                    (this.settings.item_size - calcItemSize(d)) / 2
                );
            })
            .attr("y", (d) => {
                return (
        ...
        this.labels
            ...
            .on("mouseenter", (event, d) => {
                ...
                this.items
                    ...
                    .ease(d3.easeLinear)
                    .style("opacity", (d) => {
                        return moment(d.date).isSame(selected_month, "month")
                            ? 1
                            : 0.1;
                    });
            })
        ...
        this.labels
            ...
            .on("mouseenter", (event, d) => {
                ...
                this.items
                    ...
                    .ease(d3.easeLinear)
                    .style("opacity", (d) => {
                        return moment(d.date).day() === selected_day.day()
                            ? 1
                            : 0.1;
                    });
            })
    ...
    drawMonthOverview() {
        ...
        let month_data = this.props.data.filter((d) => {
            return (
                start_of_month <= moment(d.date) &&
                moment(d.date) < end_of_month
            );
        });
        ...
        item_block
            ...
            .on("mouseover", (event, d) => {
                ...
                // Calculate tooltip position
                let x =
                    weekScale(moment(date).week()) +
                    this.settings.tooltip_padding;
                while (
                    this.settings.width - x <
                    this.settings.tooltip_width +
                        this.settings.tooltip_padding * 3
        ...
        this.labels
            ...
            .on("mouseenter", (event, weekday) => {
                ...
                this.items
                    ...
                    .ease(d3.easeLinear)
                    .style("opacity", (d) => {
                        return moment(d.date).week() === weekday.week()
                            ? 1
                            : 0.1;
                    });
            })
    ...
    drawWeekOverview() {
        ...
        let week_data = this.props.data.filter((d) => {
            return (
                start_of_week <= moment(d.date) && moment(d.date) < end_of_week
            );
        });
    ...
    drawDayOverview() {
        ...
        this.items
            ...
            .on("mouseover", (event, d) => {
                ...
                // Calculate tooltip position
                let x =
                    (d.value * 100) / (60 * 60 * 24) +
                    itemScale(moment(d.date));
                while (
                    this.settings.width - x <
                    this.settings.tooltip_width +
                        this.settings.tooltip_padding * 3
            ...
            .on("click", (event, d) => {
                if (
                    !!this.props.handler &&
                    typeof this.props.handler == "function"
                ) {
