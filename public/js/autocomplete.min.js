var Autocomplete = (function () {
    ...
    const t = (t, e) => {
        ...
        e = (t, e) =>
            (e.value = ((t) => t.firstElementChild || t)(t).textContent.trim()),
        s = (t, e) => {
        ...
        h = (t, e, s, i) => {
            const h = i.previousSibling,
                r = h ? h.offsetHeight : 0;
            if (
                    ...
                    (i.scrollTop =
                        ...
                        ((t, e) => {
                            ...
                            return (
                                [].slice
                                    .call(s)
                                    .map((t) => (i += t.offsetHeight)),
                                i
                            );
                        })(e, s)),
                t.offsetTop - r < i.scrollTop)
            )
                i.scrollTop = t.offsetTop - r;
            else {
                const e = t.offsetTop + t.offsetHeight - r;
                e > i.scrollTop + i.offsetHeight &&
                    (i.scrollTop = e - i.offsetHeight);
            }
        },
        r = 27,
        o = 13,
    ...
    return class {
        constructor(c, d) {
            ...
            (this.init = () => {
                ...
                this.clearbutton(),
                    ((e, s, i, h, r) => {
                        t(s, { id: i, tabIndex: "0", role: "listbox" }),
                            t(h, { addClass: r + "-results-wrapper" }),
                            h.insertAdjacentElement("beforeend", s),
                            e.parentNode.insertBefore(h, e.nextSibling);
                    })(s, e, this.outputUl, this.resultWrap, this.prefix),
                    s.addEventListener("input", this.handleInput),
                    this.showAll &&
                        s.addEventListener("click", this.handleInput),
                    this.onRender({ element: s, results: e });
            }),
                (this.cacheAct = (t, e) => {
                    const s = this.root;
                    this.cache &&
                ...
                (this.reset = () => {
                    ...
                    t(this.root, {
                        ...
                        ((0 ==
                            (null == (e = this.matches) ? void 0 : e.length) &&
                            !this.toInput) ||
                            this.showAll) &&
                ...
                (this.onLoading = (t) =>
                    this.root.parentNode.classList[t ? "add" : "remove"](
                        this.isLoading
                    )),
                (this.error = () => this.root.classList.remove(this.err)),
                (this.events = () => {
                    const { root: t, resultList: e } = this;
                    t.addEventListener("keydown", this.handleKeys),
                        t.addEventListener("click", this.handleShowItems),
                ...
                (this.results = (e) => {
                    ...
                    (this.itemsLi = document.querySelectorAll(
                        ...
                        s(this.resultList, this.resultWrap);
                }),
                (this.handleDocClick = (t) => {
                    let { target: e } = t,
                        s = null;
                    ((e.closest("ul") && this.disable) ||
                        e.closest("." + this.prevClosing)) &&
                        (s = !0),
                        e.id === this.id || s || this.reset();
                }),
                (this.selectFirstEl = () => {
                    const {
                        index: e,
                    ...
                    if ((this.remAria(document.querySelector("." + s)), !r))
                        return;
                    const { firstElementChild: n } = this.resultList,
                        l =
                            this.classGroup && this.matches.length > 0 && r
                ...
                (this.getTextFromLi = (t) => {
                    ...
                    t && 0 !== this.matches.length
                        ? (e(t, s),
                          ...
                          h || (this.remAria(t), this.reset()),
                          this.clearButton &&
                              this.cBtn.classList.remove("hidden"),
                          this.cacheAct("remove"))
                        : !h && this.reset();
                }),
                (this.indexLiSelected = (t) =>
                    Array.prototype.indexOf.call(this.itemsLi, t)),
                (this.handleKeys = (t) => {
                    const { root: s } = this,
                        { keyCode: h } = t,
                        c = this.resultWrap.classList.contains(this.isActive),
                        d = this.matches.length + 1;
                    switch (
                        ((this.selectedLi = document.querySelector(
                            "." + this.activeList
                        )),
                        h)
                    ) {
                        ...
                        case l:
                            if (
                                (t.preventDefault(),
                                (d <= 1 && this.selectFirst) || !c)
                            )
                                return;
                            h === n
                                ? (this.index < 0 && (this.index = d - 1),
                                  (this.index -= 1))
                                : ((this.index += 1),
                                  this.index >= d && (this.index = 0)),
                                this.remAria(this.selectedLi),
                                d > 0 && this.index >= 0 && this.index < d - 1
                                    ? (this.onSelected({
                                          index: this.index,
                                          element: s,
                                          object: this.matches[this.index],
                ...
                (this.setAria = (e) => {
                    const s =
                        this.selectedOption + "-" + this.indexLiSelected(e);
                    t(e, {
                        id: s,
                        "aria-selected": "true",
                        ...
                        i(this.root, s),
                        h(e, this.outputUl, this.classGroup, this.resultList);
                }),
                (this.remAria = (e) => {
                    e &&
                        t(e, {
                ...
                (this.destroy = () => {
                    ...
                    this.clearButton && this.cBtn.classList.add("hidden"),
                        ...
                        this.error(),
                        this.onReset(t),
                        t.removeEventListener("keydown", this.handleKeys),
                        t.removeEventListener("click", this.handleShowItems),
                ...
                (this.id = c),
                (this.root = document.getElementById(c)),
                (this.onSearch =
                    ((O = S),
                    Boolean(O && "function" == typeof O.then)
                        ? S
                        : (t) => {
                              let { currentValue: e, element: s } = t;
                              return Promise.resolve(
                                  S({ currentValue: e, element: s })
                              );
                          })),
                (this.onResults = E),
                (this.onRender = w),
                ...
                (this.classGroup = A),
                (this.prevClosing = b),
                (this.clearBtnAriLabel = C || "clear text from input"),
                (this.prefix = y ? y + "-auto" : "auto"),
                (this.disable = g),
                (this.cache = f),
