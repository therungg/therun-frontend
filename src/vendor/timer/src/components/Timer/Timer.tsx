...
import { TimeParts, TimerStateValues, Unit } from '../../types';
...
class Timer extends React.PureComponent<
    React.PropsWithChildren<TimerProps>,
    TimerState
> {
    ...
    public static getUI(
        ...
        renderProps: (props: TimerProps) => React.RecatNode,
    ) {
        if (children === null) {
            return null;
        }
    ...
    constructor(props: TimerProps) {
        ...
        const { initialTime, direction, timeToUpdate, lastUnit, checkpoints } =
            this.props;
    ...
    public render() {
        ...
        return (
            <TimerContext.Provider value={{ ms, s, m, h, d, formatValue }}>
