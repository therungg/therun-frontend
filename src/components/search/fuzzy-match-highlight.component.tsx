...
export const FuzzyMatchHighlight = React.memo<FuzzyMatchHighlightProps>(
    ({ result, highlights }) => {
...
const HighlightCharacter = React.memo<HighlightCharacterProps>(
    ({ character }) => (
        <span className="text-body fw-medium text-bg-info bg-opacity-25">
            {character}
        </span>
    ),
);
